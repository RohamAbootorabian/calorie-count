...
TypeScript + Supabase + OpenAI (GPT-4o vision). See [README.md](README.md) for the
...
## Architecture rules
- The phone **NEVER** calls the AI provider directly. Photo → Supabase Edge Function → OpenAI (GPT-4o vision) → structured `MealAnalysis` → phone. AI keys live ONLY in Edge Function secrets.
